    ...
    // else{
      ...
      // if($responseKeys['success']){
        ...
        if(isset($_POST['name'])){
          ...
          $insert = pg_query("INSERT INTO nmbtrace.trx_trace_visitor(visitor_name, visitor_contact, loc_cd, visitor_company, visitor_reason, visitor_verified, evt_cd, entry_dtm) VALUES ('$name', '$phone_num', '$loc_cd', '$company_name','$appoint_with', '$verification', '$evt_cd', '$entry_timestamp')");
          
          //navigate to page location.php
          header("Location: location/$var_loc.php");
